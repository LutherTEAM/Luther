...
NameBot = (DevRio:get(Luther..'Rio:NameBot') or 'تركس')
--     Source Luther     --
...
if text and text:match('^'..(DevRio:get(Luther..'Rio:NameBot') or "تركس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Luther..'Rio:NameBot') or "تركس")..' ','')
end
...
local BotName = (DevRio:get(Luther.."Rio:NameBot") or 'تركس')
...
if text and text == (DevRio:get(Luther..'Rio:NameBot') or 'تركس') then 
NameBot = (DevRio:get(Luther..'Rio:NameBot') or 'تركس')
...
DevRio:set(Luther..'Rio:NameBot',(DevRio:get(Luther..'Name:Bot') or 'تركس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
