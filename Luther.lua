...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1634245410,1634245410,1634245410}
Luther = Config.Luther
TokenBot = Config.TokenBot
NameBot = (DevRio:get(Luther..'Rio:NameBot') or 'لوثر')
--     Source Luther     --
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(Luther..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Luther..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if File_Name ~= "Luther.lua" then 
send(chat,msg.id_," ⌔︰هذا الملف ليس تابع لسورس لوثر")
return false 
end      
...
var = true
elseif DevRio:sismember(Luther..'Rio:Owner:'..chat_id, user_id) then
var = true
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Luther/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Luther/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Luther/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Luther/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Song:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
local Text ='*⌔︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/mp3:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/memz:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/gif:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/photo:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/anime:"..data.sender_user_id_}},{{text=". TeAm Luther ⌔",url="t.me/TFFFC"}}} 
...
DevRio:sadd(Luther..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Luther..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
DevRio:sadd(Luther..'Rio:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Ban:'..data.chat_id_,dp.id_)
...
if DevRio:sismember(Luther..'Rio:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Luther..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Luther..'Rio:BanAll:', dp.id_)
DevRio:srem(Luther..'Rio:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم الغاء العام')
end,nil)
end
...
DevRio:sadd(Luther..'Rio:Tkeed:'..data.chat_id_, dp.id_)
...
DevRio:srem(Luther..'Rio:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ˓ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TFFFC')..')\n⌔︰تم الغاء تقيده')
end,nil)
end
--     Source Luther     --
...
local Del = DevRio:get(Luther..'Rio:Del')
local Text = [[
...
DevRio:del(Luther..'Rio:Owner:'..data.chat_id_)
...
DevRio:del(Luther..'Rio:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
DevRio:del(Luther..'Rio:Constructor:'..data.chat_id_)
...
DevRio:del(Luther..'Rio:Managers:'..data.chat_id_)
Text = "*⌔︰تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Luther..'Rio:Admins:'..data.chat_id_)
...
DevRio:del(Luther..'Rio:VipMem:'..data.chat_id_)
...
DevRio:del(Luther..'Rio:Cleaner:'..data.chat_id_)
...
DevRio:del(Luther..'Rio:Muted:'..data.chat_id_)
...
local List = DevRio:smembers(Luther..'Rio:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevRio:srem(Luther..'Rio:Tkeed:'..data.chat_id_, v)
end
...
DevRio:del(Luther..'Rio:Ban:'..data.chat_id_)
...
--     Source Luther     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Luther..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevRio:smembers(Luther..'Rio:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*⌔︰لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevRio:del(Luther..'Rio:Gif:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Voice:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Audio:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Photo:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Stecker:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Video:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:File:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Text:GpRed'..v..data.chat_id_)
DevRio:del(Luther..'Rio:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Luther..'Rio:Lock:GpRd'..data.chat_id_) then
...
local List = DevRio:smembers(Luther.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevRio:del(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevRio:del(Luther.."List:Cmd:Group:New"..data.chat_id_)
end
...
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"م")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"من")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevRio:set(Luther.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Luther.."List:Cmd:Group:New"..data.chat_id_,"#")
...
DevRio:sadd(Luther..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Luther..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
DevRio:sadd(Luther..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
...
DevRio:sadd(Luther.."Rio:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevRio:sadd(Luther.."Rio:RioConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Luther.."Rio:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevRio:srem(Luther.."Rio:RioConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(Luther..'Rio:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '⌔︰المجموعه بالتاكيد مفعله')
else
Text = "⌔︰تم تفعيل المجموعه "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ TeAm Luther ›",url="t.me/TFFFC"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevRio:sadd(Luther.."Rio:Groups",data.chat_id_)
if not DevRio:get(Luther..'Rio:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
DevRio:incrby(Luther..'Rio:Sudos'..data.sender_user_id_,1)
DevRio:set(Luther..'Rio:SudosGp'..data.sender_user_id_..data.chat_id_,"rio")
end
...
DevRio:set(Luther.."Rio:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not DevRio:sismember(Luther..'Rio:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰المجموعه بالتاكيد معطله") 
else
Text = "⌔︰تم تعطيل المجموعه "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ TeAm Luther ›",url="t.me/TFFFC"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevRio:srem(Luther.."Rio:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Text = "⌔︰تم ترتيب الاوامر بالشكل التالي ~\n⌔︰ ايدي - ا .\n⌔︰ رفع مميز - م .\n⌔︰رفع ادمن - اد .\n⌔︰ رفع مدير - مد . \n⌔︰ رفع منشى - من . \n⌔︰ رفع منشئ الاساسي - اس  .\n⌔︰ رفع مطور - مط .\n⌔︰رفع مطور ثانوي - ثانوي .\n⌔︰ تنزيل الكل - تك .\n⌔︰ تعطيل الايدي بالصوره - تعط .\n⌔︰ تفعيل الايدي بالصوره - تفع .\n⌔︰ الرابط - ر .\n⌔︰ ردود المدير - رر .\n⌔︰ مسح المكتومين - ،، .\n⌔︰ اضف رد - رد .\n⌔︰ مسح سحكاتي - سح .\n⌔︰ مسح رسائلي - رس .\n⌔︰ غنيلي - غ .\n⌔︰مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ TeAm Luther ›',url="t.me/TFFFC"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
DevRio:sadd(Luther..'Rio:BasicConstructor:'..data.chat_id_,Manager_id)  
DevRio:sadd(Luther..'Rio:RioConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
DevRio:del(Luther.."Rio:Add:AllText"..data.sender_user_id_)
DevRio:del(Luther.."Rio:Add:AllRed"..data.sender_user_id_)
DevRio:del(Luther.."DelSudoRep")
Text = "⌔︰تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ TeAm Luther .',url="t.me/TFFFC"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevRio:get(Luther..'DelManagerRep'..data.chat_id_)
DevRio:srem(Luther..'Rio:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevRio:del(Luther..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevRio:del(Luther..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevRio:del(Luther..'DelManagerRep'..data.chat_id_)
Text = "⌔︰تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ TeAm Luther .',url="t.me/TFFFC"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Cmd = DevRio:get(Luther..'Rio:Cmd')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Msg = DevRio:get(Luther..'Rio:Msg')
local Text = [[
...
DevRio:del(Luther..'Rio:EditMsg'..data.chat_id_..data.sender_user_id_)
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Filter = DevRio:get(Luther..'Rio:Filter')
local Text = [[
...
DevRio:del(Luther.."Rio:FilterAnimation"..data.chat_id_)
...
DevRio:del(Luther.."Rio:FilterSteckr"..data.chat_id_)
...
DevRio:del(Luther.."Rio:FilterPhoto"..data.chat_id_)
...
DevRio:del(Luther..'Rio:Filters:'..data.chat_id_)
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local locklist = DevRio:get(Luther..'Rio:locklist')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockBotList = DevRio:get(Luther..'Rio:LockBotList')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockSpamList = DevRio:get(Luther..'Rio:LockSpamList')
local Text = [[
...
if not DevRio:get(Luther..'Rio:Lock:Join'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Join'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Join'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Join'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Text'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Text'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Text'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Text'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:TagServr'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:TagServr'..data.chat_id_) 
...
if not DevRio:get(Luther..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:EditMsgs'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:EditMsgs'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Stickers'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Stickers'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Gifs'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Gifs'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Photo'..data.chat_id_,true) 
...
if DevRio:get(Luther..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Photo'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Videos'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Videos'..data.chat_id_)
...
if not DevRio:get(Luther..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:set(Luther..'Rio:Lock:Forwards'..data.chat_id_,true)
...
if DevRio:get(Luther..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:del(Luther..'Rio:Lock:Forwards'..data.chat_id_) 
...
DevRio:set(Luther.."Rio:Lock:Bots"..data.chat_id_,"kick")  
...
DevRio:set(Luther.."Rio:Lock:Bots"..data.chat_id_,"ked")   
...
DevRio:set(Luther.."Rio:Lock:Bots"..data.chat_id_,"del")  
...
DevRio:del(Luther.."Rio:Lock:Bots"..data.chat_id_) 
...
DevRio:hset(Luther.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(Luther.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevRio:hset(Luther.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevRio:hset(Luther.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
DevRio:hdel(Luther.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Source = DevRio:get(Luther..'Rio:Source')
local Text = [[
...
os.execute('rm -rf Luther.lua') 
os.execute('wget https://raw.githubusercontent.com/LutherTEAM/Luther/master/Luther.lua') 
dofile('Luther.lua') 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Media = DevRio:get(Luther..'Rio:Media')
local Text = [[
...
local List = DevRio:smembers(Luther.."Rio:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
local List = DevRio:smembers(Luther.."Rio:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Luther.."Rio:cleanermusic"..data.chat_id_)
else
...
ChatLeave(data.chat_id_, Luther) 
DevRio:srem(Luther.."Rio:Groups",data.chat_id_)
end           
...
if not DevRio:get(Luther.."Rio:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevRio:get(Luther.."Private:Group:Link"..data.chat_id_) 
...
if not DevRio:get(Luther..'Rio:Lock:GpLinks'..data.chat_id_) then 
if DevRio:get(Luther.."Rio:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "ᯤ 𝗀𝗋𝗈𝗎𝗉 𝗅𝗂𝗇𝗄 🦎.\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Luther.."Rio:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local order = DevRio:get(Luther..'Rio:order')
local Text = [[
...
DevRio:set(Luther..'Rio:Lock:Id:Photo'..data.chat_id_,true)
...
DevRio:del(Luther..'Rio:Lock:Id:Photo'..data.chat_id_)
...
DevRio:set(Luther..'Rio:Lock:Id'..data.chat_id_,true)
...
DevRio:del(Luther..'Rio:Lock:Id'..data.chat_id_)
...
DevRio:set(Luther.."Rio:Lock:GpLinks"..data.chat_id_,"ok")
...
DevRio:del(Luther.."Rio:Lock:GpLinks"..data.chat_id_)
...
DevRio:set(Luther.."Rio:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevRio:del(Luther.."Rio:Lock:GpLinksinline"..data.chat_id_)
...
DevRio:del(Luther.."Rio:Lock:Welcome"..data.chat_id_)
...
DevRio:set(Luther.."Rio:Lock:Welcome"..data.chat_id_,true)
...
DevRio:set(Luther..'Rio:Lock:AllRed'..data.chat_id_,true)
...
DevRio:del(Luther..'Rio:Lock:AllRed'..data.chat_id_)
...
DevRio:set(Luther..'Rio:Lock:GpRed'..data.chat_id_,true)
...
DevRio:del(Luther..'Rio:Lock:GpRed'..data.chat_id_)
...
DevRio:set(Luther.."Rio:Del:Me"..data.chat_id_, true)
Text = "*⌔︰تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Luther.."Rio:Del:Me"..data.chat_id_)
Text = "*⌔︰تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Luther.."Rio:Kick:Me"..data.chat_id_, true)
...
DevRio:del(Luther.."Rio:Kick:Me"..data.chat_id_)
...
DevRio:set(Luther.."Rio:Lock:KickBan"..data.chat_id_,"true")
Text = "*⌔︰تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Luther.."Rio:Lock:KickBan"..data.chat_id_)
Text = "*⌔︰تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Luther.."Rio:Lock:ProSet"..data.chat_id_,"true")
Text = "*⌔︰تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Luther.."Rio:Lock:ProSet"..data.chat_id_)
Text = "*⌔︰تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Luther..'Rio:Lock:Games'..data.chat_id_,true)  
...
DevRio:del(Luther..'Rio:Lock:Games'..data.chat_id_) 
...
if text and text:match('^'..(DevRio:get(Luther..'Rio:NameBot') or "لوثر")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Luther..'Rio:NameBot') or "لوثر")..' ','')
end
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بتعديل وتغيير كلايش سورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '˓ السورس ⌔' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بتحديث  سورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓ تحديث السورس ⌔','˓ تحديث ⌔'},
{'˓ السيرفر ⌔'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب أحصائيات  سورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓  الاحصائيات ⌔'},
{'˓ المشتركين ⌔','˓ المجموعات ⌔'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب المطورين لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب التفعيل والتعطيل لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالاذاعه لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓ اذاعه بالتثبيت ⌔'},
{'˓ اذاعه خاص ⌔','˓ اذاعه عام ⌔'},
...
if text == '˓ العام ⌔' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالعام لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بردود الخاص لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالاشتراك الاجباري لسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓ غنيلي ⌔','˓ اغنيه ⌔'},
{'˓ ميمز ⌔','˓ ريمكس ⌔'},
{'˓ صوره ⌔','˓ متحركه ⌔'},
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بأوامر النسب الخاصه بسورس لوثر فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '˓ العاب ⌔' then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بألعاب سورس لوثر فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
tdcli_function({ID="GetUser",user_id_=Luther},function(arg,dpbot)
local inline = {
{{text="⌔ المطور .",url="t.me/"..(dp.username_ or "OO1J1")}},
{{text="⌔ السورس .",url="https://t.me/TFFFC"},{text="⌔ لتنصيب بوت .",url="https://t.me/OO1J1"}},{{text="⌔ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
DevRio:del(Luther.."Rio:Lock:AutoFile")
end
...
DevRio:set(Luther.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source Luther     --
...
local DevText = DevRio:get(Luther.."DevText")
if DevRio:get(Luther.."Rio:ChId") then DevCh = '\n⌔︰*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
if DevText then
...
{{text = '⌔ TeAm Luther .', url="t.me/TFFFC"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
--     Source Luther     --
if text and text:match("^(.*)$") then
local SaveKt = DevRio:get(Luther..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevRio:get(Luther..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Luther..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
...
DevRio:del(Luther..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevRio:del(Luther..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Luther..'Rio:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Luther..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevRio:get(Luther..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Luther..'Rio:Sudo:Kt'..msg.chat_id_,text) then
local DavidTeam =  DevRio:smembers(Luther..'Rio:Text:KtTexts'..text..msg.chat_id_)
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@TFFFC]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@TFFFC]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Luther     --
--        Contact         --
...
local BotName = (DevRio:get(Luther.."Rio:NameBot") or 'لوثر')
...
if text and text == (DevRio:get(Luther..'Rio:NameBot') or 'لوثر') then 
NameBot = (DevRio:get(Luther..'Rio:NameBot') or 'لوثر')
...
local Tsl = DevRio:get(Luther..'Rio:Tsl')
local Text = [[
...
--     Source Luther     --
if text == "الرابط" then
local Link = DevRio:get(Luther..'Rio:Link')
local Text = [[
...
if not DevRio:get(Luther..'Rio:Lock:Games'..msg.chat_id_) then
local Games = DevRio:get(Luther..'Rio:Games')
local Text = [[
...
function LutherTeam(extra,result,success)
if DevRio:get(Luther.."Rio:Send:Bot"..Luther) and not RioSudo(msg) then 
...
Text = [[
Welcome To Source
⌔︰[TeAm Luther](https://t.me/TFFFC)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ Source Channel',url="https://t.me/TFFFC"}},{{text = '⌔ Developer',url="t.me/OO1J1"},{text = '⌔ Tws Luther',url="https://t.me/YVXOAM_bot"}},{{text= '⌔ Exp Source .',url="https://t.me/FTTTER"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TFFFC&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Luther     --
...
if DevRio:sismember(Luther..'Rio:Owner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(Luther..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Luther..'Rio:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
...
DevRio:srem(Luther..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Luther..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Luther..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Luther..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(Luther..'Rio:Owner:'..msg.chat_id_,user)
...
if DevRio:get(Luther..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Luther.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(Luther.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
...
local List = DevRio:smembers(Luther..'Rio:Owner:'..msg.chat_id_)
text = "⌔︰قائمة المالكين ∵ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Luther..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or TFFFC}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..getpro.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LutherTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Luther..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local LutherTeam = '⌔︰اهلا عزيزي ˓ '..RioRank(msg)..' \n⌔︰تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LutherTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Luther..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(Luther..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(Luther.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(Luther.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Luther.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "⌔︰لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source Luther     --
...
DevRio:del(Luther..'Rio:Owner:'..msg.chat_id_)
end
end
if Owner(msg) then
...
local Text ='*⌔︰تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/gif:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌔︰تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/memz:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌔︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Song:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/remix:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌔︰تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/photo:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌔︰تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/anime:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/series:"..msg.sender_user_id_}},{{text = '⌔ Luther Team .',url="t.me/TFFFC"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/TFFFC' end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LutherTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Luther.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LutherTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Luther.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
Text = "⌔︰تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm Luther ›",url="t.me/TFFFC"}}}
...
Text = "⌔︰تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ TeAm Luther ›",url="t.me/TFFFC"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(Luther.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
if not Bot(msg) and DevRio:get(Luther..'Rio:Lock:Rd'..msg.chat_id_) then 
...
if not Bot(msg) and DevRio:get(Luther..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
local Leave = DevRio:get(Luther..'Rio:Leave')
local Text = [[
...
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/Luther/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Luther     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "˓ تحديث السورس ⌔" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰جاري تحديث سورس لوثر', 1, 'md') 
os.execute('rm -rf Luther.lua') 
os.execute('wget https://raw.githubusercontent.com/LutherTEAM/Luther/master/Luther.lua') 
dofile('Luther.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
DevRio:set(Luther..'Rio:NameBot',(DevRio:get(Luther..'Name:Bot') or 'لوثر'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LutherTEAM/LutherFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︰قائمة ملفات متجر سورس لوثر\n⌔︰الملفات المتوفره حاليا ∵\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LutherTEAM/LutherFiles/master/LutherFiles/"..FileName)
if Res == 200 then
...
if DevRio:get(Luther..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
